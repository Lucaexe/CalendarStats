...
<template>
    <div>
        <input type="checkbox" name="light_switch" id="light_switch" v-model="isDark" class="light-switch sr-only" />
        <label class="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full" for="light_switch">
